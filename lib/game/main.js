...
MyGame = ig.Game.extend({
	...
	start: function() {
		this.score = 0; 
        this.loadLevel( LevelSmallChunk );
    ...
    trackGameTime: function() {
        ...
        setInterval(function(){
            ig.game.timePlayed = ig.game.timer.delta();
    ...
    setGameSpeed: function() {
        ...
        if (this.timePlayed > 50)
            this.SPEED = SETTINGS.DEFAULT_SPEED + 50;
        else if (this.timePlayed > 40)
            this.SPEED = SETTINGS.DEFAULT_SPEED + 40;
        else if (this.timePlayed > 30)
            this.SPEED = SETTINGS.DEFAULT_SPEED + 30;
        else if (this.timePlayed > 20)
            this.SPEED = SETTINGS.DEFAULT_SPEED + 20;
        else if (this.timePlayed > 10)
            this.SPEED = SETTINGS.DEFAULT_SPEED + 10;
        else 
