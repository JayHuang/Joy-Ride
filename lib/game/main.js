...
var SETTINGS = {
    ...
    ITEM_POINTS: 50,
    ITEM_BOOST: 7,
    PROJECTILE_FIRE_RATE: 0.10 //per second
};
...
MyGame = ig.Game.extend({
	...
	placeEnemies: function(){
		...
		for (var i = 1; i <= numOfEnemies; i++){
			...
			//console.log(this.collisionMap.data[Math.round(this.screen.x + ig.system.width)][Math.round(y_pos)]);
			console.log(Math.round(this.screen.x + ig.system.width))
			console.log(Math.round(y_pos))
			
			console.log('collision:' + this.collisionMap.data)
	},
